...
/**
 * Shared global exception -> JSON mapping for every service, using the common
 * {@link ApiErrorResponse}. Each service component-scans this advice. Client/domain
 * errors are logged at WARN; truly unexpected exceptions at ERROR. Bean Validation
 * failures become 400 with per-field messages.
 */
