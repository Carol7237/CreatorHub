...
class UserServiceImplTest {
    ...
    void delete_existing_deletes() {
        // Cross-service dependency checks (posts/tiers/subscriptions) are deferred to a
        // later step now that those entities live in other services; here delete just works.
